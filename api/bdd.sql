...
INSERT INTO adherents (email, password_hash, nom, siret, adresse, code_postal, ville, telephone, date_adhesion, date_expiration) VALUES
    ...
    ('contact@boulangerie-limoges.fr',  '$2a$10$2M4LzkqwEGR9i5DoOb17YuUuaFqUYEq.gh0Lhdan7x2fxOA2Q/y.C', 'Boulangerie Ducourneau',  '55566677700055', '9 rue Turgot',          '87000', 'Limoges',  '0555000055', '2026-02-01', '2027-02-01'),
    ('hello@traiteur-vieuxport.fr',     '$2a$10$2M4LzkqwEGR9i5DoOb17YuUuaFqUYEq.gh0Lhdan7x2fxOA2Q/y.C', 'Traiteur du Vieux Port',  '66677788800066', '2 la Canebiere',        '13001', 'Marseille','0491000066', '2025-10-15', '2026-10-15'),
    ('info@fromagerie-halles.fr',       '$2a$10$2M4LzkqwEGR9i5DoOb17YuUuaFqUYEq.gh0Lhdan7x2fxOA2Q/y.C', 'Fromagerie des Halles',   '77788899900077', '4 rue Montorgueil',     '75001', 'Paris',    '0142000077', '2026-04-01', '2027-04-01');
...
INSERT INTO benevoles (email, password_hash, nom, prenom, telephone, statut_candidature) VALUES
    ...
    ('nadia.cohen@mail.fr',        '$2a$10$2M4LzkqwEGR9i5DoOb17YuUuaFqUYEq.gh0Lhdan7x2fxOA2Q/y.C', 'Cohen',   'Nadia',  '0666666666', 'valide'),
    ('thomas.leroy@mail.fr',       '$2a$10$2M4LzkqwEGR9i5DoOb17YuUuaFqUYEq.gh0Lhdan7x2fxOA2Q/y.C', 'Leroy',   'Thomas', '0677777777', 'valide'),
    ('emma.girard@mail.fr',        '$2a$10$2M4LzkqwEGR9i5DoOb17YuUuaFqUYEq.gh0Lhdan7x2fxOA2Q/y.C', 'Girard',  'Emma',   '0688888888', 'en_attente');
...
INSERT INTO collectes (adherent_id, date_collecte, statut) VALUES
    ...
    (5, '2026-08-25 08:30:00', 'effectuee'),
    (6, '2026-09-02 10:00:00', 'planifiee'),
    (7, '2026-08-27 09:00:00', 'effectuee'),
    (2, '2026-09-15 11:00:00', 'planifiee');
...
INSERT INTO produits (collecte_id, code_barre, nom, quantite, date_limite_conso, emplacement_stock, statut) VALUES
    ...
    (6, '1000000000006', 'Pain de campagne',    8, '2026-08-30', 'Etagere A3', 'en_stock'),
    (6, '1000000000007', 'Baguettes',          25, '2026-08-29', 'Etagere A4', 'en_stock'),
    (8, '1000000000008', 'Plats cuisines',      6, '2026-09-01', 'Frigo 2',    'en_stock'),
    (8, '1000000000009', 'Desserts',           10, '2026-08-31', 'Frigo 2',    'en_stock');
...
INSERT INTO destinataires (type, nom, adresse, code_postal, ville, telephone) VALUES
    ...
    ('particulier', 'M. Dubois',                   '5 rue Turgot',         '87000', 'Limoges',   '0550000004'),
    ('association', 'Secours Populaire Marseille', '12 la Canebiere',      '13001', 'Marseille', '0490000005');

INSERT INTO tournees (benevole_id, date_tournee, statut) VALUES
    (1, '2026-08-21', 'terminee'),
    (2, '2026-09-06', 'planifiee'),
    (7, '2026-08-28', 'terminee'),
    (1, '2026-09-16', 'planifiee');
...
INSERT INTO services (nom, description, capacite_id) VALUES
    ...
    ('Services de reparation electrique','Petits depannages electriques pour les adherents.',   4),
    ('Gardiennage',                      'Surveillance de commerce pendant les absences.',      NULL);
...
INSERT INTO plannings (service_id, benevole_id, date_debut, date_fin, lieu, places_max) VALUES
    ...
    (1, 6, '2026-09-19 09:00:00', '2026-09-19 12:00:00', 'Local associatif Paris',    6),
    (5, 7, '2026-09-20 10:00:00', '2026-09-20 13:00:00', 'Local associatif Marseille',4),
    (6, 1, '2026-09-22 08:00:00', '2026-09-22 18:00:00', 'Entrepot Paris',            2);
